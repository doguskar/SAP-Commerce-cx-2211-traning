...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/personalizationtrail-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/personalizationtrail-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/personalizationtrail-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/personalizationtrail-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/personalizationtrail-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>

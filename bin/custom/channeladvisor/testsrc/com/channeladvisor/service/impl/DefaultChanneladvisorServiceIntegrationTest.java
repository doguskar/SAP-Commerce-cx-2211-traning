...
import com.channeladvisor.service.impl.DefaultChanneladvisorService;
 ...
 */
@IntegrationTest
public class DefaultChanneladvisorServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "channeladvisorPlatformLogo";

		// when
		final String logoUrl = channeladvisorService.getHybrisLogoUrl(logoCode);

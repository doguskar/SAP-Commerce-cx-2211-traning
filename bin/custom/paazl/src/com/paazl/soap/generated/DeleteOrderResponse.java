...
public class DeleteOrderResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the error value for this DeleteOrderResponse.
     * 
     * @return error
     */
    ...
    /**
     * Sets the error value for this DeleteOrderResponse.
     * 
     * @param error
     */
    ...
    /**
     * Gets the success value for this DeleteOrderResponse.
     * 
     * @return success
     */
    ...
    /**
     * Sets the success value for this DeleteOrderResponse.
     * 
     * @param success
     */
    ...
    public void setSuccess(int i, String _value) {
        this.success[i] = _value;
    }

    private Object __equalsCalc = null;
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof DeleteOrderResponse)) return false;
        DeleteOrderResponse other = (DeleteOrderResponse) obj;
    ...
    public synchronized int hashCode() {
        ...
        if (getSuccess() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSuccess(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteOrderResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.paazl.com/schemas/matrix", ">deleteOrderResponse"));

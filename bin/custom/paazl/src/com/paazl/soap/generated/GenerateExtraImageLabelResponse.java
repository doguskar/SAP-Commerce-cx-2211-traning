/**
 * GenerateExtraImageLabelResponse.java
 *
...
public class GenerateExtraImageLabelResponse  implements java.io.Serializable {
    private com.paazl.soap.generated.ErrorType error;

    private com.paazl.soap.generated.LabelType[] label;

    private com.paazl.soap.generated.LabelMetaDataType[] metaData;

    public GenerateExtraImageLabelResponse() {
    }

    public GenerateExtraImageLabelResponse(
           com.paazl.soap.generated.ErrorType error,
           com.paazl.soap.generated.LabelType[] label,
    ...
    /**
     * Gets the error value for this GenerateExtraImageLabelResponse.
     * 
     * @return error
     */
    ...
    /**
     * Sets the error value for this GenerateExtraImageLabelResponse.
     * 
     * @param error
     */
    ...
    /**
     * Gets the label value for this GenerateExtraImageLabelResponse.
     * 
     * @return label
     */
    public com.paazl.soap.generated.LabelType[] getLabel() {
        return label;
    }


    /**
     * Sets the label value for this GenerateExtraImageLabelResponse.
     * 
     * @param label
     */
    public void setLabel(com.paazl.soap.generated.LabelType[] label) {
        this.label = label;
    }

    public com.paazl.soap.generated.LabelType getLabel(int i) {
        return this.label[i];
    }

    public void setLabel(int i, com.paazl.soap.generated.LabelType _value) {
        this.label[i] = _value;
    }


    /**
     * Gets the metaData value for this GenerateExtraImageLabelResponse.
     * 
     * @return metaData
     */
    ...
    /**
     * Sets the metaData value for this GenerateExtraImageLabelResponse.
     * 
     * @param metaData
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GenerateExtraImageLabelResponse)) return false;
        GenerateExtraImageLabelResponse other = (GenerateExtraImageLabelResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GenerateExtraImageLabelResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.paazl.com/schemas/matrix", ">generateExtraImageLabelResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.paazl.com/schemas/matrix", "labelType"));
        elemField.setNillable(false);

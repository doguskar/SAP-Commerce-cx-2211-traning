...
public class BatchStatusResponse  implements java.io.Serializable {
    private com.paazl.soap.generated.ErrorType error;

    private com.paazl.soap.generated.BatchStatusLabelType[][] batch;
    ...
    public BatchStatusResponse(
           ...
           com.paazl.soap.generated.BatchStatusLabelType[][] batch) {
           this.error = error;
           this.batch = batch;
    }
    ...
    /**
     * Gets the error value for this BatchStatusResponse.
     * 
     * @return error
     */
    ...
    /**
     * Sets the error value for this BatchStatusResponse.
     * 
     * @param error
     */
    ...
    /**
     * Gets the batch value for this BatchStatusResponse.
     * 
     * @return batch
     */
    public com.paazl.soap.generated.BatchStatusLabelType[][] getBatch() {
        return batch;
    }


    /**
     * Sets the batch value for this BatchStatusResponse.
     * 
     * @param batch
     */
    public void setBatch(com.paazl.soap.generated.BatchStatusLabelType[][] batch) {
        this.batch = batch;
    }

    private Object __equalsCalc = null;
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof BatchStatusResponse)) return false;
        BatchStatusResponse other = (BatchStatusResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BatchStatusResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.paazl.com/schemas/matrix", ">batchStatusResponse"));

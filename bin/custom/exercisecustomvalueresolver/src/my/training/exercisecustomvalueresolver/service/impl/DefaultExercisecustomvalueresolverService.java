...
public class DefaultExercisecustomvalueresolverService implements ExercisecustomvalueresolverService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExercisecustomvalueresolverService.class);
	...
	{
		return DefaultExercisecustomvalueresolverService.class.getResourceAsStream("/exercisecustomvalueresolver/sap-hybris-platform.png");
	}
